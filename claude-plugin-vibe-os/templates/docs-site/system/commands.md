...
VibeOS provides 9 slash commands for managing the full development lifecycle.

## /setup

**Configure VibeOS environment.**

```
/setup
```

Interactive wizard that detects your terminal, tests notifications, verifies MCP servers, and initializes `.vibeos/` state directory. Run once per project.
...
4. Create session log in `.vibeos/sessions/`
5. Save score breakdown in `.vibeos/scores/`
