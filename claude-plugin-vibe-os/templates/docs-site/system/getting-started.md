...
# Getting Started with VibeOS

VibeOS is a Claude Code plugin that transforms Claude Code into an autonomous vibe-coding operating system.
...
4. Initialize the `.vibeos/` state directory
