...
Roll back to a previous VibeOS checkpoint or git commit. Lists available checkpoints, lets the user pick a target, detects the safest rollback mode, confirms the action, and executes the rollback.

---

## Step 1: List Checkpoints

Show available VibeOS checkpoints and recent git commits.
...
1. **VibeOS Checkpoints** — tagged commits created by VibeOS before feature work.
...
Available Checkpoints:
  1. vibeos-checkpoint-2026-02-23T12-00-00Z — abc1234 — "Before feature: auth" (2026-02-23)
  2. vibeos-checkpoint-2026-02-22T15-30-00Z — def5678 — "Before feature: dashboard" (2026-02-22)
