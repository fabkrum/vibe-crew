...
features:
  ...
  - title: Kanban Board
    ...
    link: /kanban
  - title: Session Stats
    details: View total sessions, average Vibe Score, token usage, and estimated costs.
    link: /stats
  - title: Command Reference
    details: All 9 VibeCrew slash commands with usage examples and options.
