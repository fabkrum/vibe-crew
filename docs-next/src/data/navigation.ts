...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Mobile & Touch Patterns', slug: 'mobile-patterns' },
      { title: 'Responsive Patterns', slug: 'responsive-patterns' },
      { title: 'Error Handling Patterns', slug: 'error-handling-patterns' },
