...
# Scans project files excluding node_modules, .git, dist, .vibeos, vendor.
...
EXCLUDES="--exclude-dir=node_modules --exclude-dir=.git --exclude-dir=dist --exclude-dir=.vibeos --exclude-dir=vendor --exclude-dir=build --exclude-dir=.next --exclude-dir=coverage --exclude-dir=__pycache__"
